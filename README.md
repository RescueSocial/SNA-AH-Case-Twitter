...
Twitter is the most studied platform, so after a cyber intelligence researcher collected data with APIs, then obtaining analysis on it was relatively fast with previous models already created.
